import sys
import pathlib
from uni_rlhf.datasets import offline_atari
import argparse
import shortuuid
...
parser.add_argument('--task', type=str, default='boxing')
parser.add_argument('--environment_name', type=str, default='boxing-medium-v0')
...
dataset = offline_atari.Dataset(project_id=cfg.project_id, domain=cfg.domain, task=cfg.task, environment_name=cfg.environment_name, mode=cfg.mode,
