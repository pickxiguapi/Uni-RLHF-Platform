import sys
import pathlib
from uni_rlhf.datasets import offline_customization_dataset
import argparse
import shortuuid
...
parser.add_argument('--environment_name', type=str, default=f'test')
...
dataset = offline_customization_dataset.Dataset(project_id=cfg.project_id, domain=cfg.domain, task=cfg.task, environment_name=cfg.environment_name, mode=cfg.mode,
