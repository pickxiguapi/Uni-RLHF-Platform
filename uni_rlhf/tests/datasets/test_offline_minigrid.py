import sys
import pathlib
from uni_rlhf.datasets import offline_minigrid
import argparse
import shortuuid
...
dataset = offline_minigrid.Dataset(project_id=cfg.project_id, domain=cfg.domain, task=cfg.task, environment_name=cfg.environment_name, mode=cfg.mode,
