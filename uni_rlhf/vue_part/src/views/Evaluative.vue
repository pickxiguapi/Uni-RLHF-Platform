                ...
                <div class="container-right">
                    ...
                    <div class="container-right-content">
                        ...
                        <div class="middle_item">
                            <v-card v-for="(item, index) in question" :key="index" style="padding-left: 10px;padding-right: 10px; font-size: 20px; margin-bottom: 10px;" >
                                <div>Question {{ index + 1 }}: &nbsp;{{ item }}</div>
                                <v-radio-group v-model="radioGroup[index]" class="d-flex" row>
                                    <v-radio v-for="(option, oIndex) in options[index]" :key="oIndex" :label="option" :value="oIndex"></v-radio>
                                </v-radio-group>
                            </v-card>
                        </div>
